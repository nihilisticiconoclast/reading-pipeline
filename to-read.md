...
**Highbrow**
- **Season of Migration to the North** — Tayeb Salih (1966). A Sudanese village narrator confronts a charismatic returnee whose years in London curdled into something monstrous; a cold, formally doubled answer-back to *Heart of Darkness*, voted the most important Arabic novel of the 20th century. Translated non-Western literary fiction in a region the shelves have never touched.
- **The Sixth Extinction: An Unnatural History** — Elizabeth Kolbert (2014). The current mass die-off reconstructed species by species, each chapter a different scientific idea about how extinction came to be thinkable at all. Pulitzer-winning ecology beyond Attenborough — rigorous, unsentimental, ideas-first.
- **The Enigma of Reason** — Hugo Mercier & Dan Sperber (2017). Argues that reason did not evolve to find truth in solitude but to win arguments in groups — so its "bugs" (confirmation bias, motivated reasoning) are features of a social tool. Contemporary epistemology that reframes how belief and justification actually work; connects directly to the Bayesian interest.

**Lowbrow**
- **Small Gods** — Terry Pratchett (1992). The Great God Om returns to find he has exactly one true believer and the body of a tortoise; the sharpest, most self-contained thing Pratchett wrote about belief, power, and what gods are made of. Discworld at full philosophical strength, no series homework required.
- **The Big Sleep** — Raymond Chandler (1939). Philip Marlowe walks into a blackmail case and the bodies pile up faster than the plot can explain them; the prose is the point. A hardboiled lateral from le Carré's cold moral weather — unsentimental, stylish, fast.
- **The Forever War** — Joe Haldeman (1974). A conscript fights an interstellar war in which relativistic time dilation means every tour home lands him centuries adrift from the world he left. Comfort hard SF whose engine is one clean, devastating idea.
...
- **The Hour of the Star** — Clarice Lispector (1977). A Brazilian
  modernist's last book: an uneducated migrant's life narrated by a
  self-doubting alter ego who keeps interrupting to question his own
  fiction. Structurally strange, philosophically serious, unsentimental —
  and squarely in the translated, non-Western literary fiction you said is
  your biggest blind spot.
- **Stories of Your Life and Others** — Ted Chiang (2002). Eight stories
  that are almost pure conceptual payload: a language that rewrites how its
  speakers experience time, a proof that mathematics is inconsistent, free
  will under determinism. Ideas-first speculative fiction beyond the
  Golden Age, exactly the register *Piranesi* and *We* sit near.
- **Autobiography of Red** — Anne Carson (1998). A verse novel that
  retells the Greek myth of Geryon and Herakles as a contemporary
  coming-of-age story. Carson is a classicist, so the rigour is real and
